      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="xl:col-span-7 space-y-6">
          <div className="bg-white border-4 border-black p-8 rounded-[2.5rem] shadow-[8px_8px_0px_black] space-y-4">
            ...
            <input type="text" placeholder="Recipient" value={formData.recipient} onChange={e => setFormData({...formData, recipient: e.target.value})} className="w-full border-2 border-black p-4 rounded-xl font-bold bg-[var(--bg-primary)]" />
            <input type="text" placeholder="Subject" value={formData.subject} onChange={e => setFormData({...formData, subject: e.target.value})} className="w-full border-2 border-black p-4 rounded-xl font-bold bg-[var(--bg-primary)]" />
